# LeetCode 432. All O`one Data Structure 設計 AllOne 資料結構：題目 All O'one 是指全部的操作，都要在O(1)時間內做到，好像很難，尤其是找最大key、最小key。
# 看了 Editorial 的解法，發現「好像沒那麼難」，只要在「雙向linked list」裡，能加減node，配合 HashMap 就做完了。但指標太多，我寫好久。
